...
public class Discover extends javax.swing.JFrame {
    ...
    private void initComponents() throws SQLException {
        ...
        String[] setList = main.conn.getSets();

        
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
        	
            
            public int getSize() { return setList.length; }
            public String getElementAt(int i) { return setList[i]; }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 2039, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addGap(107, 107, 107)
                .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, 1926, Short.MAX_VALUE)
                .addContainerGap())
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
    	try {
			main.conn.addToCollection(jList1.getSelectedValue());
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //search sets
    	try {
			String[] list = main.conn.getSetsSearch(jTextField1.getText());
